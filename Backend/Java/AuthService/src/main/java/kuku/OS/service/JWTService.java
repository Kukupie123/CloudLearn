...
public class JWTService {
    ...
    public String createToken(Map<String, String> claims) throws InvalidEnvironmentVariable {
        ...
        if (claims != null) for (String key : claims.keySet()) {
...
class JwtHelperFunctions {
    public int parseExpirationType(String expirationType) throws InvalidEnvironmentVariable {
        ...
        throw new InvalidEnvironmentVariable("Invalid Expiration Type String. Passed " + expirationType + ", minute,hour,month are allowed");
    }
}